...
void TaskVariable::setGains(double _a,double _b){
  targetType=pdgainTT;
  active=true;
  Pgain=_a;
  Dgain=_b;
...
void TaskVariable::setGainsAsNatural(double oscPeriod,double dampingRatio){
  targetType=pdgainTT;
  active=true;
...
void TaskVariable::setGainsAsAttractor(double decaySteps,double oscillations){
  targetType=pdgainTT;
  active=true;
  Dgain=2./decaySteps;
