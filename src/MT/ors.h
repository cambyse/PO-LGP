...
struct TaskVariable{
  ...
  void setGains(double _a,double _b);
  void setGainsAsNatural(double decaySteps,double dampingRatio);
  void setGainsAsAttractor(double decaySteps,double oscillations=.2);
