...
MESSAGE(STATUS "Looking for flycapture API")
...
IF(WIN32)
  ...
  SET(FLYCAPTURE_LIBNAME "FlyCapture")
ELSE(WIN32)
  # Assume headers and libraries are installed in FHS locations
...
FIND_LIBRARY(FLYCAPTURE_LIBRARY ${FLYCAPTURE_LIBNAME} ${FLYCAPTURE_TEST_LIB_PATHS})
