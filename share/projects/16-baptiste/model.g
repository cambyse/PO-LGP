...
Merge baseH { X=<T t(1.5 0. 1.1) d(-180 0 0 1)> }
...
shape humanL(left_wristH){ rel=<T t(0 -.05 0)> type=5 color=[1 0 0] size=[.1 0 0 0] }
shape humanR(right_wristH){ rel=<T t(0 -.05 0)> type=5 color=[1 0 0] size=[.1 0 0 0] }
