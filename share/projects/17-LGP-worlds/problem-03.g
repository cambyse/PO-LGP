...
joint (table1 redBall) { from=<T t(0 0 .02)> to=<T t(.3 -.7 .03)> type=JT_rigid }

### tools

body stick1 { type=9 size=[.8 .025 .04 .01] color=[.6 .3 0] contact }
joint (table1 stick1) { from=<T t(0 0 .02)> to=<T t(-.2 -.7 .02)> type=JT_rigid}

### wall

body wall { type=9 size=[2. .4 .05 .01] color=[.6 .3 0] contact }
joint (table1 wall) { from=<T t(0 0 .02)> to=<T t(0 .9 .2) d(90 1 0 0)> type=JT_rigid}
