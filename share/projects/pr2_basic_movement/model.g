...
body table2{ type=0, X=<T t(.6 0 .7)>, size=[.8 .8 .04 .02], color=[.8 .5 .3] }
...
#shape objTarget2(table2) { type=ST_marker rel=<T t(-.1 0 .03)> size=[.3 0 0 0] color=[1 .5 0] }

#body ball { X=<T t(-1 -1.2 1.)>, size=[.1 .1 .2 .02] type=9 }
#body ball2 { X=<T t(-1 -1.2 1.5)>, size=[.1 .1 .2 .02] type=9 }

body obj1 { size=[.06 .06 .04 0] type=0 color=[.8 .8 .2] coloredBox percept }
joint (table2 obj1) { from=<T t(0 -.15 .02)> to=<T t(0 0 .02)> type=JT_transXYPhi agent=1 }
...
shape target(table2) { type=ST_marker rel=<T t(0. 0. 0.) d(0 0 0 1)> size=[.3 0 0 0] color=[1 .5 0] }
