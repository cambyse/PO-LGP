...
#right
#body container_0 { X=<T t(-.4 -0.6 1.23)> contact }
#shape container_0_front(container_0)  { type=9 rel=<T t(0  0.15 0.15)> size=[0.3 0.01 0.3 0.01]   color=[1 0 0] contact }
#shape container_0_left(container_0)   { type=9 rel=<T t(.15  0.0  0.15)> size=[0.01 0.3 0.3 0.01] color=[1 0 0] contact }
#shape container_0_right(container_0)  { type=9 rel=<T t(-.15 0.0  0.15)> size=[0.01 0.3 0.3 0.01] color=[1 0 0] contact }
#shape container_0_bottom(container_0) { type=9 rel=<T t(0  0.0 0)> size=[0.3 0.3 0.01 0.01]     color=[1 0 0] contact }
...
#body container_0 { type=9 X=<T t(-.18 -0.6 1.23) d(-40 0 0 1)> size=[0.3 0.3 0.01 0.01]     color=[1 0 0] contact}
...
#body container_1 { type=9 X=<T t(.0 -1.0 1.23)> size=[0.3 0.3 0.01 0.01]     color=[1 0 0] contact }
...
#body tableCC{ type=9, X=<T t(0 -.8 1.1)>, size=[2. .7 .24 .01], color=[.3 .5 .3] contact }
