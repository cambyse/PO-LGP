...
void overtake()
{
  ...
  // get sight
  komo.addObjective( 2.0, 3.0, new AxisBound( "car_ego", 0.0, AxisBound::Y, AxisBound::MIN ), OT_sos );
...
void cooperative()
{
  ...
  // road bounds
  komo.addObjective( 0.0, -1, new AxisBound( "car_ego", -0.12, AxisBound::Y, AxisBound::MIN ), OT_ineq );
  komo.addObjective( 0.0, -1, new AxisBound( "car_ego",  0.12, AxisBound::Y, AxisBound::MAX ), OT_ineq );

  komo.addObjective( 0.0, -1, new AxisBound( "truck", -0.12, AxisBound::Y, AxisBound::MIN ), OT_ineq );
  komo.addObjective( 0.0, -1, new AxisBound( "truck", -0.075, AxisBound::Y, AxisBound::MIN, 0.1 ), OT_sos );
  komo.addObjective( 0.0, -1, new AxisBound( "truck",  0.12, AxisBound::Y, AxisBound::MAX ), OT_ineq );

  komo.addObjective( 0.0, -1, new AxisBound( "car_op", -0.12, AxisBound::Y, AxisBound::MIN ), OT_ineq );
  komo.addObjective( 0.0, -1, new AxisBound( "car_op",  0.075, AxisBound::Y, AxisBound::MIN, 0.1 ), OT_sos );
  komo.addObjective( 0.0, -1, new AxisBound( "car_op",  0.12, AxisBound::Y, AxisBound::MAX ), OT_ineq );
...
void cooperative_2()
{
  ...
  komo.addObjective( 0.0, -1, new AxisBound( "truck_2", -0.12, AxisBound::Y, AxisBound::MIN ), OT_ineq );
  komo.addObjective( 0.0, -1, new AxisBound( "truck_2", -0.075, AxisBound::Y, AxisBound::MIN, 0.1 ), OT_sos );
  komo.addObjective( 0.0, -1, new AxisBound( "truck_2",  0.12, AxisBound::Y, AxisBound::MAX ), OT_ineq );
  ...
  arr truck_speed{ 0.03, 0, 0 };
  komo.setVelocity( 0.0, -1, "truck", NULL, OT_eq, truck_speed );
  komo.addObjective( 0.0, -1, new AxisBound( "truck_2",  0.00, AxisBound::X, AxisBound::MIN ), OT_ineq, - arr{ 0.03 }, 1e2, 1 );
...
void cooperative_3()
{
  ...
  komo.addObjective( 0.0, -1, new AxisBound( "truck",  0.00, AxisBound::X, AxisBound::MIN ), OT_ineq, - arr{ 0.025 }, 1e2, 1 );
  komo.addObjective( 0.0, -1, new AxisBound( "truck",  0.00, AxisBound::X, AxisBound::MAX ), OT_ineq,  arr{ 0.04 }, 1e2, 1 );
  komo.addObjective( 0.0, -1, new AxisBound( "truck_2",  0.00, AxisBound::X, AxisBound::MIN ), OT_ineq, - arr{ 0.03 }, 1e2, 1 );
...
void cooperative_4()
{
  ...
  komo.addObjective( 0.0, -1, new AxisBound( "car_1", -0.12, AxisBound::Y, AxisBound::MIN ), OT_ineq );
  komo.addObjective( 0.0, -1, new AxisBound( "car_1",  0.12, AxisBound::Y, AxisBound::MAX ), OT_ineq );

  komo.addObjective( 0.0, -1, new AxisBound( "car_2", -0.12, AxisBound::Y, AxisBound::MIN ), OT_ineq );
  komo.addObjective( 0.0, -1, new AxisBound( "car_2",  0.12, AxisBound::Y, AxisBound::MAX ), OT_ineq );

  komo.addObjective( 0.0, -1, new AxisBound( "car_3", -0.12, AxisBound::Y, AxisBound::MIN ), OT_ineq );
  komo.addObjective( 0.0, -1, new AxisBound( "car_3",  0.12, AxisBound::Y, AxisBound::MAX ), OT_ineq );
  ...
  // vehicle speeds
  komo.addObjective( 0.0, -1, new AxisBound( "truck",  0.00, AxisBound::X, AxisBound::MIN ), OT_ineq, - arr{ 0.025 }, 1e2, 1 );
  komo.addObjective( 0.0, -1, new AxisBound( "truck",  0.00, AxisBound::X, AxisBound::MAX ), OT_ineq,  arr{ 0.045 }, 1e2, 1 );

  komo.addObjective( 0.0, -1, new AxisBound( "car_1",  0.00, AxisBound::X, AxisBound::MIN ), OT_ineq, - arr{ 0.03 }, 1e2, 1 );
  komo.addObjective( 0.0, -1, new AxisBound( "car_1",  0.00, AxisBound::X, AxisBound::MAX ), OT_ineq,  arr{ 0.045 }, 1e2, 1 );

  komo.addObjective( 0.0, -1, new AxisBound( "car_2",  0.00, AxisBound::X, AxisBound::MIN ), OT_ineq, - arr{ 0.03 }, 1e2, 1 );
  komo.addObjective( 0.0, -1, new AxisBound( "car_2",  0.00, AxisBound::X, AxisBound::MAX ), OT_ineq,  arr{ 0.045 }, 1e2, 1 );

  komo.addObjective( 0.0, -1, new AxisBound( "car_3",  0.00, AxisBound::X, AxisBound::MIN ), OT_ineq, - arr{ 0.03 }, 1e2, 1 );
...
void cooperative_5()
{
  ...
  komo.addObjective( 0.0, -1, new AxisBound( "car_1",  0.00, AxisBound::X, AxisBound::MIN ), OT_ineq, - arr{ 0.025 }, 1e2, 1 );
  komo.addObjective( 0.0, -1, new AxisBound( "car_1",  0.00, AxisBound::X, AxisBound::MAX ), OT_ineq,  arr{ 0.045 }, 1e2, 1 );
  ...
  komo.addObjective( 0.0, -1, new AxisBound( "car_3",  0.00, AxisBound::X, AxisBound::MIN ), OT_ineq, - arr{ 0.03 }, 1e2, 1 );
  komo.addObjective( 0.0, -1, new AxisBound( "car_3",  0.00, AxisBound::X, AxisBound::MAX ), OT_ineq,  arr{ 0.045 }, 1e2, 1 );
...
void cooperative_flying()
{
  ...
  // min speed
  komo.addObjective( 0.0, -1, new AxisBound( "car_ego",  0.00, AxisBound::X, AxisBound::MIN ), OT_ineq, - arr{ 0.05 }, 1e2, 1 );
  ...
  komo.addObjective( 0.0, -1, new AxisBound( "car_2",  0.00, AxisBound::X, AxisBound::MIN ), OT_ineq, - arr{ 0.025 }, 1e2, 1 );
  //komo.addObjective( 0.0, -1, new AxisBound( "car_2",  0.00, AxisBound::X, AxisBound::MAX ), OT_ineq,  arr{ 0.04 }, 1e2, 1 );

  komo.addObjective( 0.0, -1, new AxisBound( "car_3",  0.00, AxisBound::X, AxisBound::MIN ), OT_ineq, - arr{ 0.025 }, 1e2, 1 );
  //komo.addObjective( 0.0, -1, new AxisBound( "car_3",  0.00, AxisBound::X, AxisBound::MAX ), OT_ineq,  arr{ 0.04 }, 1e2, 1 );
...
void lane_insertion()
{
  ...
  // min speed
  komo.addObjective( 0.0, -1, new AxisBound( "car_ego",  0.00, AxisBound::X, AxisBound::MIN ), OT_ineq, - arr{ 0.025}, 1e2, 1 );
