...
struct W
{
  ...
  void addSwitch_stable(double time, const mp::Vars & branch, double p, const char* from, const char* to);
  void addSwitch_stableOn(double time, const mp::Vars & branch, double p, const char* from, const char* to);
