...
using namespace std;
using namespace mdp; //Environment + Cannon
using namespace mlr;


int main(int argc, char *argv[]){

    ENVIRONMENT * env; //pointer to class; defined in environment.h
    ...
    env = new CANNON(2,2, 1.); //CANNON - inherits ENVIRONMENT - sDim, aDim, discount
    numEpisode = 200;
    H = 1; //just one step? - in rollout() mentioned 20
    numCentres = 100;
    numRuns = 10;
    numIterations = 5000;
    ...
    RKHSPol rkhs1(*env,numCentres,H,numEpisode,numIterations); //defined in functional.h
    mlr::rnd.clockSeed();
    arr rewards;
