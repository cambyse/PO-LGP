...
joint (table yellow) { from=<T t(0 0 0.02)> to=<T t(0 0 .105)> type=JT_rigid }
joint (blue red)     { from=<T t(0 0 0.05)> to=<T t(0 0 .105)> type=JT_rigid }
joint (table blue)   { from=<T t(0 .1 .02)> to=<T t(0 0 .105)> type=JT_rigid }
