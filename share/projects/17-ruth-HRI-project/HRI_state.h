...
struct HRIObject {
  ...
  HRIObject* above_obj=NULL;
  bool isAbove(HRIObject* s);
  bool overlapping(HRIObject* s);
...
struct  OnTableState {
  ...
  void setObjectPosition(HRIObject::Color objColor, HRIObject::Size objSize, mlr::Vector objPosition);
  bool findObjectInPercepts(PerceptL percepts, HRIObject::Color objColor, HRIObject::Size objSize, mlr::Vector targetPos);
