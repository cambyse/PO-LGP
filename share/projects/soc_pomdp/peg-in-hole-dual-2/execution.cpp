...
void getTrajectory(arr& x, arr& y, arr& dual, ors::KinematicWorld& world, arr x0, const arr& model, bool stickyness, uint horizon){
  ...
  TaskCost *cons = P.addTask("planeConstraint", new PlaneConstraint(world, "peg", ARR(0,0,-1, world.getBodyByName("hole")->X.pos.z + 0.5)));//0.2 is table width  //0.05 above table surface to avoid slippery
