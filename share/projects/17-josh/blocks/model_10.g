...
joint (table yellow) { from=<T t(0 .115 0.04)> to=<T d(45 1 0 0) t(0 0 .05)> type=JT_rigid }
joint (table red)    { from=<T t(0 .0 0.02)> to=<T t(0 0 .05)> type=JT_rigid }
joint (table blue)   { from=<T t(0 -.115 .04) > to=<T d(-45 1 0 0) t(0 0 .05)> type=JT_rigid }
