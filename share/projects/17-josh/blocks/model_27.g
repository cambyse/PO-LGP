...
joint (table red) { from=<T t(0 0 0.02)> to=<T t(0 0 .025)> type=10 }
joint (red yellow) { from=<T t(0 0 0.025)> to=<T t(0 0 .025)> type=10 }
joint (yellow blue) { from=<T t(0 0 .025)> to=<T t(0 0 .05)> type=10 }
