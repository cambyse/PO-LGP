...
joint (blue yellow) { from=<T t(0 +.05 -.045)> type=JT_rigid }
joint (table red)    { from=<T t(0 -.1 .07) > type=JT_rigid }
joint (white blue)   { from=<T t(0 -.035 .075) d(90 1 0 0)> type=JT_rigid }
joint (table black)  { from=<T t(0 .14 .07)> type=JT_rigid }
joint (table white)  { from=<T t(0  +.025 0.07) > type=JT_rigid }
