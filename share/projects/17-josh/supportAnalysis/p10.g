...
joint (table yellow) { from=<T t(0  .155 .07)> type=JT_rigid }
joint (table red)    { from=<T t(0 .07 .07) d(30 1 0 0) > type=JT_rigid }
joint (table blue)   { from=<T t(0 -.015 .07) d(-30 1 0 0)> type=JT_rigid }
joint (white black)  { from=<T t(0 -.0 .075) d(90 1 0 0)> type=JT_rigid }
joint (table white)  { from=<T t(0  -.105 .07)> type=JT_rigid }
