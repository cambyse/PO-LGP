...
joint (table yellow) { from=<T t(0  .1 .07) d(45 1 0 0)> type=JT_rigid }
joint (table red)    { from=<T t(0 .025 .07) > type=JT_rigid }
joint (table blue)   { from=<T t(0 -.05 .07) d(-45 1 0 0)> type=JT_rigid }
joint (table black)  { from=<T t(0 -.15 .07)> type=JT_rigid }
joint (table white)  { from=<T t(0  +.2 0.07) > type=JT_rigid }
