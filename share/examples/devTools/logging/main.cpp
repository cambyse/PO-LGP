...
// set your logger with SET_LOG(<NAME>, <LEVEL>), a name is just a name for a
...
int main() {
  ...
  INFO(main, "Some INFO text.");
  WARN(main, "Some WARN text.");
  ...
  // ERROR messages are printed to std::cerr instead of std::cout. They don't
  // halt the programm.
