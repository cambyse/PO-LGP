...
void TEST(Meshes) {
  OpenGL gl;
  ors::Mesh mesh;
  mesh.readStlFile(FILE("~/share/data/3dmodel/schunk-hand.stl"));
  mesh.scale(.001);
...
void TEST(Meshes2) {
  ...
  mesh1.readTriFile(FILE("~/share/data/3dmodel/schunk-arm-e3.tri"));
  mesh2.readTriFile(FILE("~/share/data/3dmodel/schunk-hand-e3.tri"));
...
void TEST(Meshes3) {
  ...
  mesh.readTriFile(FILE("~/share/data/3dmodel/schunk-hand-e4.tri"));
