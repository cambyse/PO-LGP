...
body table{ type=0, X=<T t(0 -1.2 .5)>, size=[1. 1. .04 .02], color=[.8 .5 .3] contact fixed }
...
body table2{ type=0, X=<T t(1.2 0 .5)>, size=[1. 1. .04 .02], color=[.8 .5 .3] contact fixed }
...
body obj2 { size=[.1 .1 .2 .02] type=0 X=<T t(0 -1.2 .6) t(.3 .3 .02) t(0 0 .1) t(0 0 .01)> }
