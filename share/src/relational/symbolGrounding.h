...
void getFeatureVectors(mlr::Array< arr >& fs, const ors::KinematicWorld& C, const uintA& objs);
void calculateSymbols(LitL& lits, const mlr::Array<GroundedSymbol*>& sgs, ors::KinematicWorld* C);
