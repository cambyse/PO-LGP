...
struct KOMO{
  ...
  struct Task* setTreeTask(double startTime, double endTime, const uintA& path, TaskMap* map, ObjectiveType type=OT_sumOfSqr, const arr& target=NoArr, double prec=1e2, uint order=0);
