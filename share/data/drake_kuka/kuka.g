...
frame iiwa_link_0(iiwa_base_joint) 	{  mass=5 }
frame iiwa_link_0_1(iiwa_base_joint) 	{  shape=ST_mesh size=[  1 1 1 0.1  ] color=[ 0.4 0.4 0.4 1 ]  mesh='meshes/visual/link_0_x.tri'  }
frame iiwa_link_0_0(iiwa_base_joint) 	{  Q=<T -0.015 0 0.07 1 0 0 0 >  shape=ST_cylinder size=[  0 0 0.17 0.139  ] color=[ 0.8 0.2 0.2 0.5 ] contact,  }
...
frame iiwa_link_1_1(iiwa_joint_1) 	{  Q=<T -0 -0 -0 -0.707107 0 -0.707107 0 >  shape=ST_mesh size=[  1 1 1 0.1  ] color=[ 0.4 0.4 0.4 1 ]  mesh='meshes/visual/link_1_x.tri'  }
...
frame iiwa_link_2_1(iiwa_joint_2) 	{  Q=<T -0 -0 -0 -0.707107 0 -0.707107 0 >  shape=ST_mesh size=[  1 1 1 0.1  ] color=[ 1 0.423529 0.0392157 1 ]  mesh='meshes/visual/link_2_x.tri'  }
...
frame iiwa_link_3_1(iiwa_joint_3) 	{  Q=<T -0 -0 -0 -0.707107 0 -0.707107 0 >  shape=ST_mesh size=[  1 1 1 0.1  ] color=[ 0.4 0.4 0.4 1 ]  mesh='meshes/visual/link_3_x.tri'  }
...
frame iiwa_link_4_1(iiwa_joint_4) 	{  Q=<T -0 -0 -0 -0.707107 0 -0.707107 0 >  shape=ST_mesh size=[  1 1 1 0.1  ] color=[ 1 0.423529 0.0392157 1 ]  mesh='meshes/visual/link_4_x.tri'  }
...
frame iiwa_link_5_1(iiwa_joint_5) 	{  Q=<T -0 -0 -0 -0.707107 0 -0.707107 0 >  shape=ST_mesh size=[  1 1 1 0.1  ] color=[ 0.4 0.4 0.4 1 ]  mesh='meshes/visual/link_5_x.tri'  }
...
frame iiwa_link_6_1(iiwa_joint_6) 	{  Q=<T -0 -0 -0 -0.707107 0 -0.707107 0 >  shape=ST_mesh size=[  1 1 1 0.1  ] color=[ 1 0.423529 0.0392157 1 ]  mesh='meshes/visual/link_6_x.tri'  }
frame iiwa_link_6_0(iiwa_joint_6) 	{  Q=<T -0 -0 -0 -0.707107 0 -0.707107 0 >  shape=ST_mesh size=[  1 1 1 0.1  ] color=[ 0.8 0.2 0.2 0.5 ]  mesh='meshes/collision/link_6_x.tri' contact,  }
...
frame iiwa_link_7_1(iiwa_joint_7) 	{  Q=<T -0 -0 -0 -0.707107 0 -0.707107 0 >  shape=ST_mesh size=[  1 1 1 0.1  ] color=[ 0.4 0.4 0.4 1 ]  mesh='meshes/visual/link_7_x.tri'  }
frame iiwa_link_7_0(iiwa_joint_7) 	{  Q=<T -0 -0 -0 -0.707107 0 -0.707107 0 >  shape=ST_mesh size=[  1 1 1 0.1  ] color=[ 0.8 0.2 0.2 0.5 ]  mesh='meshes/collision/link_7_x.tri' contact,  }
frame >iiwa_joint_ee(iiwa_joint_7) 	{  Q=<T 0.045 0 9.99201e-18 -1 0 0 0 >  }
frame >tool0_joint(iiwa_joint_7) 	{  Q=<T 0.045 0 9.99201e-18 -1 0 -2.44826e-12 0 >  }
frame iiwa_joint_ee(>iiwa_joint_ee) 	{  joint=JT_rigid ctrl_H=1 }
frame tool0_joint(>tool0_joint) 	{  joint=JT_rigid ctrl_H=1 }
frame iiwa_link_ee_kuka(iiwa_joint_ee) 	{  Q=<T -0 -0 -0 -0.707107 0 -0.707107 0 >  }
frame iiwa_link_ee(tool0_joint) 	{  }
