...
vector<QString> Commander::print_commands(int space) const {
    // return
    vector<QString> ret;
    // get maximum lengths
...
QString Commander::add_space(int from, int to) const {
    QString ret;
...
void Commander::execute(QString command_name) const {
    for(auto c : commands) {
