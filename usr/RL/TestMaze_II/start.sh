...
## Button World
start_string="--env button --button_n 6 -m               TEM --minT 4 --maxT 20 --incT 4 --minH -1 --maxH 0 --extH 1 --minCycles 2 -e 10 -r 25 --l1 0.001 --delta 1e-5 "
start_string="--env button --button_n 6 -m VALUE_BASED_UTREE --minT 4 --maxT 20 --incT 4                                           -e 10 -r 50                         "
start_string="--env button --button_n 6 -m               TEL --minT 4 --maxT 20 --incT 4 --minH -1 --maxH 0 --extH 1 --minCycles 3 -e 10 -r 25 --l1 1e-10 --delta 1e-10"
