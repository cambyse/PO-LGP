...
## 4x4_III Maze
# start_string="--env 4x4_III -m TEL --minT 1000 --maxT 1000 --incT 0 --minH -3 --maxH -1 --extH 3 --minCycles -3 --maxCycles 3 -e 22 -r 10 --l1 1e-4 --delta 1e-10"
 start_string="--env 4x4_III -m TEM --minT 1000 --maxT 1000 --incT 0 --minH -3 --maxH  0 --extH 1 --minCycles -3 --maxCycles 3 -e 22 -r 10 --l1 1e-3 --delta 1e-5"
