...
plot [0:5100][:] \
     ...
     data_folder.'4x4_III_UTREE_VALUE_plot.txt' u 1:2:3 w errorbars pt PT ps PS lt 2 lw 2 t 'U-Tree (value)', \
     data_folder.'4x4_III_UTREE_PROB_plot.txt' u 1:2:3 w errorbars pt PT ps PS lt 3 lw 2 t 'U-Tree (model)', \
     data_folder.'4x4_III_SPARSE_plot.txt' u 1:2 w l lt 1 lw 2 t '', \
     data_folder.'4x4_III_UTREE_VALUE_plot.txt' u 1:2 w l lt 2 lw 2 t '', \
     data_folder.'4x4_III_UTREE_PROB_plot.txt' u 1:2 w l lt 3 lw 2 t ''
unset mytics; \
set ytics auto; \
unset format;
plot [:][:] \
     ...
     data_folder.'4x4_III_UTREE_PROB_plot.txt' u 1:3 w lp pt PT ps PS lt 3 lw 2 t 'U-Tree (model-based)'
...
plot [:][:] data_folder.'4x4_III_UTREE_PROB.txt' u ($2+rn(10)):($4+rn(0.01)) w p pt 0 ps 1 lt 3 lw 2 t 'U-Tree (model-based)'
