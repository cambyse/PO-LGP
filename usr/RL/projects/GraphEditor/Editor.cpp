...
QTreeWidgetItem *Editor::item_to_tree_item(const Parser::Graph::Node &item)
{
...
//    value_string += QString("(%1, %2)").arg(item.value_start).arg(item.value_end);
    ...
    case Parser::Graph::Node::BOOL:
        value_type_string = "BOOL";
        break;
    case Parser::Graph::Node::STRING:
        value_type_string = "STRING";
        break;
    case Parser::Graph::Node::FILE:
        value_type_string = "FILE";
        break;
    case Parser::Graph::Node::DOUBLE:
        value_type_string = "DOUBLE";
        break;
    case Parser::Graph::Node::ARRAY:
        value_type_string = "ARRAY";
        break;
    case Parser::Graph::Node::LIST:
        value_type_string = "LIST";
        break;
    case Parser::Graph::Node::SPECIAL:
        value_type_string = "SPECIAL";
        break;
    case Parser::Graph::Node::KVG:
        value_type_string = "KVG";
        break;
    case Parser::Graph::Node::NONE:
    ...
    if(item.value_type==Parser::Graph::Node::KVG) {
...
void Editor::tree_item_clicked(QTreeWidgetItem * item, int column)
{
    ...
    for(auto idx_it=idx_list.begin(); idx_it!=idx_list.end();) {
        ...
        ++idx_it;
        if(item_it->value_type!=Parser::Graph::Node::KVG && idx_it!=idx_list.end()) {
            ERROR("Not KVG");
        }
