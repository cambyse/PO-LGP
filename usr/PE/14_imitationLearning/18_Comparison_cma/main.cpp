...
void run() {
  ...
  param = ARRAY(0.00128167, 22.4908, 22.744, 17.7858 ,3.04831, 1.3858, 0.899768);
...
//  param = ARRAY(0.111264, 72.6097 ,24.1469, 41.017 ,31.9636, 5.92353, 31.0656);
//  param = ARRAY(0.111264, 40.6097 ,40.1469, 41.017 ,40.9636, 40.92353, 40.0656);
  param = ones(cmaD,1)*5.;param.flatten();//ARRAY(0.00180892, 16.7261, 89.5033, 21.8877, 13.7254, 1.78447, 1.39885);
//  param = trainScenes.last().paramRef;
  param = ARRAY(  0.00115659, 22.2208, 21.7075, 11.2698, 1.76874, 1.2577, 0.380254);
  // = ARRAY(  0.00179734, 1.17867, 0.271111, 0.364266, 0.278265, 0.306423, 0.379597);//20.*ones(param.d0);
  //  paramStd = ARRAY( 2.33471e-05, 0.0550647, 0.0149182 ,0.0139366, 0.0117777, 0.0110984, 0.0196474 );
  arr paramStd = ARRAY( 0.000126209, 0.0460171, 0.181301, 0.134023, 0.0482699, 0.055595, 0.471794 );
