function model = twolink_maccepa_model2
% parameters for MACCEPA arm when link 1 and link 2 are flipped
...
%%%%% definition of the robot parameters (flipped parameters)
m = [m2 m1]'; 
l = [l2 l1]'; 
lc = [l2-lc2 l1-lc1]';
